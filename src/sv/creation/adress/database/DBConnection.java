...
public class DBConnection {
	...
	public void createTables() {
		...
		try {
			...
			stmnt.executeUpdate("CREATE TABLE IF NOT EXISTS Duty (DutyID VARCHAR(30) NOT NULL PRIMARY KEY, "
	...
	public void fillUmlaufplanIntoTables() {
		...
		ss.readTxtUmlaufplan();
		  ...
		  while((it.hasNext()&&it2.hasNext()&&it3.hasNext())){
			  ...
			  stmnt.executeUpdate("INSERT INTO Block VALUES('"+it.next()+"','"+it2.next()+"','"+it3.next()+"');"); }
...
//		  Iterator<String> it9 = StringSplitter.getDutyelementArrTime().iterator(); 
		 ...
		 // Iterator<String> it11 = StringSplitter.getDutyelementServiceJourneyCode().iterator();
		  ...
		  stmnt.executeUpdate("INSERT INTO Duty VALUES('"+it.next()+"','"+it2.next()+"');"); }
	...
	public void fillFahrplanIntoTables(){
		...
		ss.readTxtFahrplan();
		  ...
		  while((it.hasNext()&&it2.hasNext()&&it3.hasNext())){
			  ...
			  stmnt.executeUpdate("INSERT INTO Stoppoint VALUES('"+it.next()+"','"+it2.next()+"','"+it3.next()+"');");
			  }
		  
		  while((it4.hasNext()&&it5.hasNext()&&it6.hasNext())){
			  stmnt.executeUpdate("INSERT INTO Line VALUES('"+it4.next()+"','"+it5.next()+"','"+it6.next()+"');"); 
		  }
		  
		  while((it7.hasNext()&&it8.hasNext()&&it9.hasNext()&&it10.hasNext()&&it11.hasNext()&&it12.hasNext()&&it13.hasNext())){
			  
			  stmnt.executeUpdate("INSERT INTO VehicleType VALUES('"+it7.next()+"','"+it8.next()+"','"+it9.next()+"','"+it10.next()+"','"+it11.next()+"','"+it12.next()+"','"+it13.next()+"');"); 
		  }
		  
		  while((it14.hasNext()&&it15.hasNext()&&it16.hasNext())){
			  stmnt.executeUpdate("INSERT INTO VehicleTypeGroup VALUES('"+it14.next()+"','"+it15.next()+"','"+it16.next()+"');"); 
		  }
		  ...
		  while((it23.hasNext()&&it24.hasNext()&&it25.hasNext()&&it26.hasNext()&&it27.hasNext()&&it28.hasNext()&&it29.hasNext()&&it30.hasNext()&&it31.hasNext()&&it32.hasNext()&&it33.hasNext()&&it34.hasNext()&&it35.hasNext()&&it36.hasNext())){
			  ...
			  stmnt.executeUpdate("INSERT INTO ServiceJourney VALUES('"+it23.next()+"','"+it24.next()+"','"+it25.next()+"','"+it26.next()+"','"+it27.next()+"','"+it28.next()+"','"+it29.next()+"','"+it30.next()+"','"+it31.next()+"','"+it32.next()+"','"+it33.next()+"','"+it34.next()+"','"+it35.next()+"','"+it36.next()+"');"); 
		  }
		  ...
		  while((it43.hasNext()&&it44.hasNext()&&it45.hasNext()&&it46.hasNext())){
			  stmnt.executeUpdate("INSERT INTO Reliefpoint VALUES('"+it43.next()+"','"+it44.next()+"','"+it45.next()+"','"+it46.next()+"');"); 
		  }
		  
		  while((it47.hasNext()&&it48.hasNext())){
			  stmnt.executeUpdate("INSERT INTO Day VALUES('"+it47.next()+"','"+it48.next()+"');"); 
		  }
